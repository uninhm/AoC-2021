...
Tuple!(int, int) solve(int[] numbers, Tuple!(int, int)[int][] indices, bool[5][5][] checkboards) {
...
void main() {
  ...
  int[] numbers = input.readln.chomp.split(",").map!(to!int).array;
